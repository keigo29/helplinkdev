  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div class="grid gap-12 sm:grid-cols-2 xl:grid-cols-3 xl:gap-16">
      ...
      <div class="flex flex-col items-center">
        <div class="mb-6 flex h-12 w-12 items-center justify-center rounded-lg bg-sky-600 text-white shadow-xl md:h-14 md:w-14 md:rounded-xl">
        ...
        <a href="#" class="font-bold text-sky-500 transition duration-100 hover:text-sky-600 active:text-sky-700">More</a>
      </div>
      {/* <!-- feature - end -->
